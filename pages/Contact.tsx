      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20">
          <div>
            ...
            <p className="text-lg text-brand-text-s font-medium mb-12">Have a question, feedback, or need help with your account? Fill out the form and our team will get back to you within 24 hours.</p>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6 items-center">
                ...
                <div>
                  <p className="text-xs font-black uppercase text-brand-text-s tracking-widest">Call Us</p>
          ...
          <div className="bg-brand-surface p-10 md:p-12 rounded-[3rem] border border-brand-text-s/10 shadow-xl relative overflow-hidden">
            {success ? (
              <div className="text-center py-20 space-y-6 animate-in zoom-in-95">
                ...
                <p className="text-brand-text-s font-medium">We've received your message and will respond shortly.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full px-6 py-4 bg-brand-bg rounded-2xl border-2 border-transparent focus:border-brand-primary outline-none font-bold transition-all"
                  />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase text-brand-text-s tracking-widest ml-1">Your Message</label>
                  <textarea 
                    rows={5} required
                ...
                <button 
                  ...
                  className="w-full py-5 bg-brand-primary text-white rounded-2xl font-black uppercase tracking-widest flex items-center justify-center gap-3 shadow-xl shadow-brand-primary/20 hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50"
                >
